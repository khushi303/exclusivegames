...
const Footer = () => {
    return (
        <div className='bg-black pt-5 position-relative ellipse_footer1 overflow-hidden'>
            <Container className='pb-5 position-relative z-2 custom_container'>
                <Row>
                    <Col lg={4} className=''>
                        <a href="">
                    ...
                    <Col lg={8} className='mt-lg-0 mt-4 pt-lg-0 pt-2'>
                        <Row>
                            ...
                            <Col lg={4} sm={6} className='col-12 pt-lg-0 pt-4 px-lg-0'>
                                <ul className='mb-0 list-unstyled'>
                                    <li className='ff_inter fs_sm fw-bold text-white lh_160 pb-2 mb-1'>Ponerse en contacto</li>
                                    <li className='mb-2'><Mail /> <a href="https://mail.google.com/mail" target='blank' className='ff_inter fs_sm fw-medium text-white op_08 lh_120 text-nowrap footer_link position-relative'>juegosexclusivos@gmail.com</a></li>
                                    <li className='mb-2'><Phone /> <a href="tel:9050385982" className='ff_inter fs_sm fw-medium text-white op_08 lh_120 footer_link position-relative'>(101)342-7873</a></li>
                                </ul>
                            </Col>
                        </Row>
                    </Col>
            ...
            <div className='border_footer py-4'>
