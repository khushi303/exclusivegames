                    ...
                    <div data-aos="fade-down" className="accordion-item w-100">
                        <h2 className="accordion-header">
                            <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <p className='mb-0 ff_anton fs_md fw-normal text-white lh_130 pe-lg-0 pe-3'>¿Cuáles son las ventajas de elegir Juegos Exclusivos para mis plataformas de juegos?</p>
                            </button>
                        </h2>
                    ...
                    <div data-aos="fade-down" className="accordion-item w-100">
                        <h2 className="accordion-header">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                <p className='mb-0 ff_anton fs_md fw-normal text-white lh_130 pe-lg-0 pe-3'>¿Cómo garantizan la seguridad de las operaciones en sus juegos?</p>
                            </button>
                        </h2>
                    ...
                    <div data-aos="fade-down" className="accordion-item w-100">
                        <h2 className="accordion-header">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                <p className='mb-0 ff_anton fs_md fw-normal text-white lh_130 pe-lg-0 pe-3'>¿Qué métodos de pago aceptan?</p>
                            </button>
                        </h2>
                    ...
                    <div data-aos="fade-down" className="accordion-item w-100">
                        <h2 className="accordion-header">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                <p className='mb-0 ff_anton fs_md fw-normal text-white lh_130 pe-lg-0 pe-3'>¿Puedo probar sus juegos antes de comprometerme?</p>
                            </button>
                        </h2>
