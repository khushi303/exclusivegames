        ...
        <div className='razons_padding razon_ellipse1 position-relative'>
            <Container className='position-relative z-2'>
                <Row className='flex-lg-row flex-column-reverse'>
                    <Col lg={6} data-aos="fade-right" className='mt-lg-0 mt-4 pt-lg-0 pt-2 d-flex justify-content-center justify-content-lg-start'>
                        <img src={Razonesimg} alt="Razonesimg" className='w-100 br_16 me-3 mw_558' />
                    </Col>
                    <Col lg={6} className='d-lg-flex flex-column justify-content-between align-items-start'>
